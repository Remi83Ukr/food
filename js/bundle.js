...
function calc() {
    ...
    function initLocalItem(selector, activeClass) {
    ...
    initLocalItem('#gender div', 'calculating__choose-item_active');
    initLocalItem('.calculating__choose_big div', 'calculating__choose-item_active');
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_form__WEBPACK_IMPORTED_MODULE_2__["default"])(modalTimerId);
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', "2021-09-18");
